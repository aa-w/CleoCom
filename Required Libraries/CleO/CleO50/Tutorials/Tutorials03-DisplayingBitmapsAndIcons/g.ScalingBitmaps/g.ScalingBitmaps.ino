...
void setup()
{
  ...
  CleO.StringExt(FONT_MEDIUM, centerX - 200, 320, LIGHT_GREEN, ML, 0, 0, "25%");

  /* Scale down to 25% of bitmap */
  CleO.BitmapTransform(0.25, 0);
  CleO.Bitmap(handle, centerX - 200, 340);

  CleO.StringExt(FONT_MEDIUM, centerX + 175, 320, LIGHT_GREEN, ML, 0, 0, "50%");

  /* Scale down to 50% of bitmap */
  CleO.BitmapTransform(0.50, 0);
  CleO.Bitmap(handle, centerX + 175, 340);
