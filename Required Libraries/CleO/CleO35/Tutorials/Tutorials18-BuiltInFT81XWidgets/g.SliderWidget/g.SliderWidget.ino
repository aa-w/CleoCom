...
void setup()
{
  ...
  CleO.eve_slider(x, y - 100, w, h, options, value1, range);
  CleO.eve_slider(x, y, w, h, options, value2, range);
  CleO.eve_slider(x, y + 100, w, h, options, value3, range);
