...
void setup()
{
  ...
  CleO.CircleExt(160, 240, 140, 160, DARK_ORANGE, MM, 0, 0);

  /* Draw 5 circles each at 72 degrees starting from bottom down */
  for (int a = 0; a < 360; a += 72)
    CleO.CircleExt(160, 240, 40, 50, LIGHT_BLUE, MM, a, 150);

  /* Set the background color to be gradient from top left corner to
  bottom right corner */
  CleO.SetBackgroundGradient(0, 0, 320, 480, DARK_BLUE, DARK_RED);
