...
/**
  ...
  Hardware Connection:
    Connect CleOWifi module to CleO35 CN3 connector
*/
...
#define W   (int16_t)(320)
#define H   (int16_t)(480)
#define FONT_A FONT_SANS_1
#define FONT_B FONT_TINY
#define FONT_TEMP   FONT_SANS_7
#define FONT_TODAY  FONT_SANS_3
#define FONT_DESCRIPTION  FONT_SANS_2
...
void setup() {
	...
	h_esp_enable = CleO.OpenGPIO(CLEO35_CN5_2, Bridge::Output, Bridge::pad_pull_none);
	h_esp_reset = CleO.OpenGPIO(CLEO35_CN5_1, Bridge::Output, Bridge::pad_pull_none);
	...
	h_esp_comm = (uint8_t)CleO.OpenUART(Bridge::CleO35_CN5, Bridge::b115200, ESP_READ_TIMEOUT);
...
void build_screen(bool refresh) {
	...
	CleO.SetBackgroundGradient(0, 0, 320, 480, pgm_read_dword(&BgColors[MySelection[flag4Day]]), pgm_read_dword(&BgColors[MySelection[flag4Day]]));
