...
#define CENTER_Y                              (0.5 * SCREEN_HEIGHT)

#define TIMER_RADIUS                          (0.4 * SCREEN_WIDTH)
...
void drawTimer() {
  ...
  CleO.StringExt(FONT_SANS_2, CENTER_X, 10, WHITE, MM, 0, 0, "Timer");
  ...
  CleO.CircleExt(CENTER_X, CENTER_Y, TIMER_RADIUS + 19, TIMER_RADIUS + 20, WHITE, MM, 0, 0);
  CleO.CircleExt(CENTER_X, CENTER_Y, TIMER_RADIUS - 5, TIMER_RADIUS, WHITE, MM, 0, 0);
  CleO.LineColor(WHITE);
  CleO.LineR1R2(CENTER_X, CENTER_Y, TIMER_RADIUS - 15, TIMER_RADIUS - 5, minAngle);
  CleO.PointExt(CENTER_X, CENTER_Y, 4, WHITE, minAngle, TIMER_RADIUS - 15);
  CleO.PointExt(CENTER_X, CENTER_Y, 2, BLACK, minAngle, TIMER_RADIUS - 15);

  /* Display inner circle and needle */
  CleO.CircleExt(CENTER_X, CENTER_Y + (TIMER_RADIUS / 2) + 10, 17, 20, WHITE, MM, 0, 0);
  CleO.CircleExt(CENTER_X, CENTER_Y + (TIMER_RADIUS / 2) + 10, 2, 5, WHITE, MM, 0, 0);
  CleO.NeedleColor(BLACK);
  CleO.NeedleXY(CENTER_X, CENTER_Y + (TIMER_RADIUS / 2) + 10, 20, msecAngle);

  /* Display current timer */
  CleO.StringExt(FONT_SANS_4, CENTER_X, CENTER_Y, WHITE, MM, 0, 0, timerString);
}
