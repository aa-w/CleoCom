...
#define DISP_MAX    (uint16_t)(320)
#define PLOT_SIZ    (byte) (64)
#define HEART_X     (480 - 162 / 2) /* Position of Heart bitmap */
#define HEART_Y     (100)
#define BPM_X       (480 - 162 / 2) /* Position of Heart Rate text */
#define BPM_Y       (230)
#define HR_MAX      (160)           /* Sanity limits for detected HR */
#define HR_MIN      (30)
#define MV_WINDOW_WIDTH     (12)
#define C_DECIMATE_N  (1)

/* X-coordinates of plot are per-computed for simplicity */
int16_t XTicks[] = { 0, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 60, 65, 70,
...
bool error_1; /* Set if HR Click errors are detected */
...
void i2c_read(byte reg, byte* pData, byte len) {
  ...
  Wire.requestFrom((uint8_t)I2C_ADR, (uint8_t)len, (uint8_t)true);
